...
function validate4(val) {
    v1 = document.getElementById("DCarrera");
...
v1 = document.getElementById("Unidad Ejecutora");
v2 = document.getElementById("Ingreso");
v3 = document.getElementById("Renglon");
v4 = document.getElementById("opt");
v5 = document.getElementById("Funciones");
